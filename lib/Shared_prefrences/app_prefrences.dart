...
class AppPreferences {
  ...
  void setShowAdd({required bool showAdd}) => _setPreference(
      prefName: prefShowAdd, prefValue: showAdd, prefType: prefTypeBool);
  Future<String> getShowAdd() async => await _getPreference(
      prefName:
      prefShowAdd); // Check value for NULL. If NULL provide default value as FALSE.
  ...
  void setUserId({required String userId}) => _setPreference(
      prefName: prefUserId, prefValue: userId, prefType: prefTypeString);
  ...
  void setFirstLogin({required int firstLogin}) => _setPreference(
  ...
  void setShowOnBoarding({required bool showOnBoarding}) => _setPreference(
      prefName: prefShowOnBoarding, prefValue: showOnBoarding, prefType: prefTypeBool);
  ...
  void setNotification({required bool loggedIn}) => _setPreference(
      prefName: prefNotification, prefValue: loggedIn, prefType: prefTypeBool);
  ...
  void setUserPhoneNumber({required String phoneNumber}) => _setPreference(
      prefName: prefUserPhoneNumber, prefValue: phoneNumber, prefType: prefTypeString);
  ...
  Future<String?> getUserDetail() async =>
      await _getPreference(prefName: prefUserDetails);
  ...
  Future<String?> getAccessToken({required prefName}) async =>
  ...
  void setUserEmailForForgotPassword({required String email}) => _setPreference(
      prefName: prefEmailForForgotPassword, prefValue: email, prefType: prefTypeString);

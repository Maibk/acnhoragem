...
class VechicleController extends GetxController {
  ...
  TextEditingController vehicleNoController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController makeController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController modelController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController colorController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController engineNoController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController chassisController = TextEditingController(text: kDebugMode ? "abc" : null);
  //user controller
  TextEditingController userfullNameController = TextEditingController(text: kDebugMode ? "abc" : null);
  TextEditingController userCnicController = TextEditingController(text: kDebugMode ? "54284-6781369-1" : null);
  TextEditingController userMobileController = TextEditingController(text: kDebugMode ? "abc" : null);
